...
from experiments.supervised.cnn_lstm.model import CNN_LSTM
from experiments.supervised.cnn_lstm.data_loader import TorchDataset
...
def get_args(subject_idx):
    ...
    parser.add_argument('--ckpt_path', default=os.path.join('..', '..', '..', 'ckpt', 'supervised', 'cnn_lstm'))
...
class Trainer(object):
    def __init__(self, args):
        super().__init__()
        self.args = args
        self.model = CNN_LSTM(kernel_size=args.kernel_size,
